...
class CredentialList:
    ...
    def from_mnemonic(cls,
        ...
        with click.progressbar(key_indices, label=load_text(['msg_key_creation']),
            ...
            return cls([Credential.from_mnemonic(mnemonic=mnemonic, mnemonic_password=mnemonic_password,                                   index=index, amount=amounts[index - start_index], chain_setting=chain_setting,
