    ...
    return (
        <Grid templateColumns='repeat(2, 1fr)' gap={6}>
            <GridItem w='100%' h='10'>
                <Center>
                    {props.backVisible && (
                        <Button variant="white-button" maxWidth={'300px'} size={'sm'} onClick={props.goBackStep}>
                            {props.backText}
                        </Button>
                    )}
                </Center>
            ...
            <GridItem w='100%' h='10'>
                <Center>
                    {props.nextVisible && (
                        <Button variant="white-button" maxWidth={'300px'} size={'sm'} onClick={props.goNextStep} {...props.nextProps}>
                            {props.nextText}
                        </Button>
                    )}
                </Center>
